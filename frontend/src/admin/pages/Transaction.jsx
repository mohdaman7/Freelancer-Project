...
// import { Search, Filter, Download, ArrowUpDown, Eye, RefreshCcw, CreditCard, Wallet } from "lucide-react"
...
//         {children}
//         <button onClick={() => onOpenChange(false)} className="mt-4 px-4 py-2 bg-gray-200 rounded-md">
//           Close
//         </button>
//       </div>
//     </div>
...
//                   </div>
//                 </th>
//                 <th className="h-10 px-4 text-left align-middle font-medium">Project</th>
//                 <th className="h-10 px-4 text-left align-middle font-medium">Client</th>
//                 <th className="h-10 px-4 text-left align-middle font-medium">Developer</th>
...
//                 <tr key={transaction.id} className="border-b transition-colors hover:bg-gray-100">
...
//           <div className="text-sm text-gray-500">Showing 1-10 of 50 transactions</div>
//           <div className="flex space-x-2">
//             <button className="inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 border border-gray-300 bg-white shadow-sm hover:bg-gray-50 h-9 px-4 py-2">
//               Previous
//             </button>
