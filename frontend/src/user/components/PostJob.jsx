  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        ...
        {
          ...jobData,
          skillsRequired: skillsRequiredString,
        },
        {
          headers: {
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-16">
            <div className="text-center text-white">
              ...
              <p className="text-xl text-blue-100 mb-8">
                Post your job and connect with top-tier tech talent from around
                the world
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 space-y-6">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">
                        All developers are pre-vetted and skill-tested
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">
                        Get matched with developers within 48 hours
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">
                        AI-powered matching for your specific needs
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-gray-800 rounded-2xl shadow-xl p-6">
                ...
                <p className="text-gray-400">
                  Join our rapidly growing platform with over 5,000 new
                  developers and 1,000 new projects monthly.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              <div>
                ...
                <p className="text-gray-400">
                  Connect with developers from over 150 countries
                </p>
              </div>
              <div>
                ...
                <p className="text-gray-400">
                  Hire within days, not weeks or months
                </p>
              </div>
              <div>
                ...
                <p className="text-gray-400">
                  Get high-quality work from skilled developers
                </p>
              </div>
            </div>
          </div>
